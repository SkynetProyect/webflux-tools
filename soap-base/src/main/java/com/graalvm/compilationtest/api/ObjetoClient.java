...
public class ObjetoClient {
    ...
    public ObjetoClient(WebServiceTemplate webServiceTemplate) {
        this.webServiceTemplate = webServiceTemplate;
    }

    @EventListener(ApplicationReadyEvent.class)
    public void init() {
        System.out.println("Application ready, starting test");
        try {
            Objeto objeto = getObjetoById(1L);
    ...
    private Source buildRequest(Long id) {
        System.out.println(" Metodo buildRequest ");
